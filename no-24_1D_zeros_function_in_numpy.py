...
#Accessing 1D zeros() Funtion elements
#no-3
from numpy import*
a = zeros(5)
print(a)
...
#Accessing 1D zeros() Funtion elements using for loop
#without index
#no-4
import numpy as np
val = np.zeros(7)
...
#Accessing 1D zeros() Funtion elements using while loop
#no-6
import numpy as np
val = zeros(7)
n = len(val)
